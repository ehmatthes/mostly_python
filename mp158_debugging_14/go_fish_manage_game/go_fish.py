...
class GoFish:
    ...
    def manage_game(self):
        # Manage the overall flow of a single game.
    ...
    def check_finished(self):
        ...
        # If auto-playing, play through specified number of games.
        if cli_args.auto_play and self.completed_games < cli_args.num_games:
            self.start_game()
